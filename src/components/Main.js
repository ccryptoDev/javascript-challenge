          ...
          <div className="max-w-sm rounded overflow-hidden shadow-lg mb-3.5">
            ...
            <div>
              <div className="grid grid-cols-7">
                <div className="col-start-1 col-span-1 ml-2.5">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                </div>
                <div className="col-start-2 col-span-6 font-normal text-base">
                  Location
                </div>
                <div className="col-start-2 col-span-6 font-normal text-2xl">
                  London,United Kingdom
                </div>
                <div className="col-start-1 col-span-1 mt-10 ml-2.5">
                ...
                <div className="col-start-2 col-span-6 font-normal text-base mt-10">
                  Product Categories
                </div>
